...
if ( ! function_exists( 'sta_settings_speed_function' ) ) {
	function sta_settings_speed_function() {
		...
		$html = '<p>'.__( 'Select the speed to Anchor JS Wordpress Plugins', 'scroll-to-anchor' ).'</p>';
...
function sta_settings_section( $arg ) {
	echo '<h2 id="' . $arg['id'] . '">' . __( 'Anchor JS Wordpress Plugin Settings', 'scroll-to-anchor' ) . '</h2>';
}
